...
def init_files_and_directories_if_not_exist():
...
def get_stations_info_from_json():
...
def write_stations_info_to_json(stations_info):
    with open(stations_info_path, 'w') as stations_info_file:
        json.dump(stations_info, stations_info_file)


def get_directory_path_for_station_data(station_id):
    return stations_data_path + "/" + station_id + "/data"


def create_directory_for_station(station_id):
...
def get_stations_data_from_file(station_id):
